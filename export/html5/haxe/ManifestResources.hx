...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_stg1s_mp3 extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_stg1_intro_mp3 extends null { }
...
@:keep @:file("assets/music/stg1s.mp3") @:noCompletion #if display private #end class __ASSET__assets_music_stg1s_mp3 extends haxe.io.Bytes {}
@:keep @:file("assets/music/stg1_intro.mp3") @:noCompletion #if display private #end class __ASSET__assets_music_stg1_intro_mp3 extends haxe.io.Bytes {}
