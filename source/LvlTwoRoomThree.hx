...
class LvlTwoRoomThree extends LevelState
{
	override public function create()
	{
		...
		bgColor = 0xffcccccc;
		createLevel();
		nextLevel = LvlTwoRoomFour;
		currLevel = LvlTwoRoomThree;
	...
	{
		map = new FlxOgmo3Loader(AssetPaths.map1__ogmo, AssetPaths.lvl2room3__json);
		if (LevelStats.hard_mode)
		{
			map = new FlxOgmo3Loader(AssetPaths.map1__ogmo, AssetPaths.lvl2room3hard__json);
		}
