...
class LvlThreeRoomFifteen extends LevelState
{
	override public function create()
	{
		super.create();
		room_no = RoomNo.L3R15;
	...
	{
		map = new FlxOgmo3Loader(AssetPaths.map1__ogmo, AssetPaths.lvl3room15__json);
