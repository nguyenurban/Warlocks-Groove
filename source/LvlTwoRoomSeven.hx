...
class LvlTwoRoomSeven extends LevelState
{
	override public function create()
	{
		...
		bgColor = 0xffcccccc;
		createLevel();
		nextLevel = LvlTwoRoomEight;
		currLevel = LvlTwoRoomSeven;
	...
	{
		map = new FlxOgmo3Loader(AssetPaths.map1__ogmo, AssetPaths.lvl2room7__json);
		if (LevelStats.hard_mode)
		{
			map = new FlxOgmo3Loader(AssetPaths.map1__ogmo, AssetPaths.lvl2room7hard__json);
		}
