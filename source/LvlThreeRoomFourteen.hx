...
class LvlThreeRoomFourteen extends LevelState
{
	override public function create()
	{
		super.create();
		room_no = RoomNo.L3R14;
		FlxG.fixedTimestep = false;

		end_of_level = false;
		bgColor = 0xffcccccc;
		createLevel();
		nextLevel = LvlThreeRoomFifteen;
		currLevel = LvlThreeRoomFourteen;
	...
	{
		map = new FlxOgmo3Loader(AssetPaths.map1__ogmo, AssetPaths.lvl3room14__json);
		if (LevelStats.hard_mode)
		{
			map = new FlxOgmo3Loader(AssetPaths.map1__ogmo, AssetPaths.lvl3room14hard__json);
		}
