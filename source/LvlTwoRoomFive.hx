...
class LvlTwoRoomFive extends LevelState
{
	override public function create()
	{
		...
		bgColor = 0xffcccccc;
		createLevel();
		nextLevel = LvlTwoRoomSix;
		currLevel = LvlTwoRoomFive;
	...
	{
		map = new FlxOgmo3Loader(AssetPaths.map1__ogmo, AssetPaths.lvl2room5__json);
		if (LevelStats.hard_mode)
		{
			map = new FlxOgmo3Loader(AssetPaths.map1__ogmo, AssetPaths.lvl2room5hard__json);
		}
