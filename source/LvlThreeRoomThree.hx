...
class LvlThreeRoomThree extends LevelState
{
	override public function create()
	{
		...
		bgColor = 0xffcccccc;
		createLevel();
		nextLevel = LvlThreeRoomFour;
		currLevel = LvlThreeRoomThree;
	...
	{
		map = new FlxOgmo3Loader(AssetPaths.map1__ogmo, AssetPaths.lvl3room3__json);
		if (LevelStats.hard_mode)
		{
			map = new FlxOgmo3Loader(AssetPaths.map1__ogmo, AssetPaths.lvl3room3hard__json);
		}
